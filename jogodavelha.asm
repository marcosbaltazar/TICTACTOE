...
strVencedor: string "ganhou! XUPA FEDERAL      "	; espaços extras para facilitar formatação
strResetStr: string "Aperte espaco para reiniciar RACA CAASO!                         "
apagaString: string "                             "
